class B_REDI_Platoon_Lead : REDI_base_soldier{
	...
	linkedItems[] 				= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_TeamLeader_AMC"};
	respawnLinkedItems[]		= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_TeamLeader_AMC"};
...
class B_REDI_Squad_Lead : REDI_base_soldier{
	...
	linkedItems[] 				= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_TeamLeader_Belt_AMC"};
	respawnLinkedItems[]		= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_TeamLeader_Belt_AMC"};
...
class B_REDI_Team_Lead : REDI_base_soldier{
	...
	linkedItems[] 				= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Grenadier_AMC"};
	respawnLinkedItems[]		= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Grenadier_AMC"};
	weapons[] 					= {"SMA_Steyr_gl_acc", "hgun_Rook40_F","Laserdesignator",Throw, Put};
	respawnWeapons[] 			= {"SMA_Steyr_gl_acc", "hgun_Rook40_F","Laserdesignator",Throw, Put};
	magazines[] 				= { OFFICER_GR, AR_SIX_MAG,UGL_STAND,NINEMM,"Laserbatteries" };
	respawnMagazines[] 			= { OFFICER_GR, AR_SIX_MAG,UGL_STAND,NINEMM,"Laserbatteries" };
...
class B_REDI_Machine_Gunner : REDI_base_soldier{
	...
	side = 1;
	faction = "B_REDI_joint";
	linkedItems[] 				= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Hgunner_Belt_AMC"};
	respawnLinkedItems[]		= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Hgunner_Belt_AMC"};
...
class B_REDI_Missile_Specialist : REDI_base_soldier{
	...
	linkedItems[] 				= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Assaulter_AMC"};
	respawnLinkedItems[]		= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Assaulter_AMC"};
...
class B_REDI_marksman : REDI_base_soldier{
	...
	linkedItems[] 				= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Marksman_AMC"};
	respawnLinkedItems[]		= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Marksman_AMC"};
...
class B_REDI_Combat_Medic : B_base_medic{
	...
	linkedItems[] 				= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Medic_AMC"};
	respawnLinkedItems[]		= {LINKED_ITEMS,"ADFU_H_OpsCore_02_AMC","REDI_V_TBAS_Medic_AMC"};
	weapons[] 					= { "SMA_Steyr_acc", "hgun_Rook40_F",Throw, Put};
	respawnWeapons[] 			= { "SMA_Steyr_acc", "hgun_Rook40_F",Throw, Put};
